...
public class ToastUtil {
    ...
    public Toast displayLongToast(final String text) {
        new Thread() {
            ...
            public void run() {
                ...
                longToast = Toast.makeText(MainApplication.getApplication(), text, Toast.LENGTH_LONG);
                longToast.show();
                Looper.loop();
            }
        }.start();
    ...
    public static Toast displayShortToast(final String text) {
        new Thread() {
            ...
            public void run() {
                ...
                shortToast = Toast.makeText(MainApplication.getApplication(), text, Toast
						.LENGTH_SHORT);
                shortToast.show();
                Looper.loop();
            }
    ...
    public Toast displayCustomDurationToast(final String text, final int duration) {
        new Thread() {
            ...
            public void run() {
                ...
                customDurationToast = Toast.makeText(MainApplication.getApplication(), text,
						duration);
    ...
    public static void showShort(String info) {
        if (toast == null) {
            toast = Toast.makeText(MainApplication.getApplication(), info, Toast.LENGTH_SHORT);
        } else {
            toast.setText(info);
        }
        toast.show();
    ...
    public static void showLong(String info) {
        if (toast == null) {
            toast = Toast.makeText(MainApplication.getApplication(), info, Toast.LENGTH_LONG);
        } else {
            toast.setText(info);
        }
        toast.show();
